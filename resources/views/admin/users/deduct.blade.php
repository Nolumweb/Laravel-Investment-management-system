...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">All Credit Transaction</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Credit Transaction Method </h4>
    ...
    <tr>
        ...
        <td>
            @if($item->status == 'pending')
                <a href="#" class="btn btn-info sm" title="Edit Data" onclick="openPaymentModal( '{{ $item->amount }}', '{{ $item->user->email }}', '{{ $item->feedback }}','{{ $item->id }}')"><i class="fa fa-pencil-alt"></i></a>
            @else
                <a href="#" class="btn btn-info sm" title="View Data" onclick="openPaymentModal( '{{ $item->amount }}', '{{ $item->user->email }}','{{ $item->feedback }}', '{{ $item->id }}')"><i class="fas fa-eye"></i></a>
            @endif
        </td>
    </tr>
@endforeach
