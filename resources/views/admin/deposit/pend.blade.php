                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <img src="{{ asset("storage/$item->payment_proof") }}" alt="Evidence of Payment" class="img-fluid mb-3">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        @if($item->status == 'pending')
                                                        <form method="POST" action="{{ route('admin.deposit.approve', ['id' => $item->id]) }}">
                                                            @csrf
                                                            <button type="submit" class="btn btn-success">Approve</button>
                                                        </form>
                                                        <form method="POST" action="{{ route('admin.deposit.reject', ['id' => $item->id]) }}">
                                                            @csrf
